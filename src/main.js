                ...
                <div class="row">
                    <div class="col-6 ">
                        ...
                        <div class="font-weight-bold">
                            ...
                            <p>Registro:<span id="registro" style="text-decoration: underline;">&nbsp </span> </p>
                    ...
                    <div class="row">
                        <div class="col-6 ">
                            ...
                            <div class="font-weight-bold">
                                ...
                                <p>Registro:<span id="registro" style="text-decoration: underline;"></span> </p>
                                <p>Semestre:<span id="registro" style="text-decoration: underline;">&nbsp${sB} </span> </p>
                            </div>
            ...
            <body>
                <div class="container">
                    <div class="row">
                            ...
                            <div class="row pl-3"><p>Registro:<span id="registro" style="text-decoration: underline;">&nbsp </span> </p>
...
function genePdf(contenido, nam) {
    ...
    const data = pdf.create(contenido, options).toFile(dialog.showSaveDialogSync({ defaultPath: `${nam}.pdf` }), function (err, res) {
